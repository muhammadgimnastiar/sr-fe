...
const SignupSchema = Yup.object().shape({
  ...
  password: Yup.string()
    ...
    .max(16, "Password must be at max 16 characters long")
    .matches(
      /^(?=.*[A-Z])(?=.*[0-9])/,
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="container py-8 px-4 mx-auto max-w-screen lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-4 mt-2 text-lg font-normal text-gray-500 lg:text-xl xl:text-start lg:text-start md:text-center sm:text-center max-[640px]:text-center">
              Please register your account first
            </p>
            <Link
              to={"/"}
              className="text-textColor hover:underline font-medium text-lg inline-flex items-center xl:justify-start lg:justify-start md:justify-center sm:justify-center max-[640px]:justify-center"
            >
              Back to Home
              <svg
